...
def test_rabbitmq_report():
    ...
    assert result.get("clusters").get('rabbit@controller1').get('cluster_name') == 'rabbit@controller0.external.s4-southlake.vcp.vzwops.com'
    ...
    assert result.get("clusters").get('rabbit@controller2').get('cluster_name') == 'rabbit@controller0.external.s4-southlake.vcp.vzwops.com'
